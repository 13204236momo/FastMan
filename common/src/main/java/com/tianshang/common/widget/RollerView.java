...
public class RollerView extends View {
    ...
    private int mLineColor = 0xFF4500;
    ...
    private void init() {
        ...
        mLinePaint.setColor(mColorText);
        mLinePaint.setStrokeWidth((float) 1.0);
    ...
    private void drawLine(Canvas canvas) {
        canvas.drawLine(40,mViewHeight*8/27,mViewWidth-40,mViewHeight*8/27,mLinePaint);
        canvas.drawLine(40,mViewHeight*19/27,mViewWidth-40,mViewHeight*19/27,mLinePaint);
