...
public class PullOrderFragment extends BaseViewFm<PullOrderFmPresenter, PullOrderFmContract.View> {
    ...
    public PullOrderFragment(int type) {
        this.type = type;
    }
    ...
    protected void initView(View view, Bundle savedInstanceState) {
        ...
        list.add("到12栋圆通快递取件");
        list.add("到三食堂买大份黄焖鸡");
        adapter = new PullOrderAdapter(list);
        rvOrder.setAdapter(adapter);
    }


    @Override
    public PullOrderFmContract.View getContract() {
        return null;
    }

    @Override
    public PullOrderFmPresenter getPresenter() {
        return new PullOrderFmPresenter();
    }
}
